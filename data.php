            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>Source Tracking</a>
                        </li>
                        <li>
                            <a href="form.html">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="images/icon/avatar-01.png" alt="Don Bosco School, Alaknanda" />
                                        </div>
                                        <div class="content">
...
<?php 
    ...
    if ($result=mysqli_query($conn,$sql))
    {
	  ...
	  echo "<center><H1 id='header'>West Kidwai Nagar (Zone 6)</H1></center><br>";

 echo "<input type='text' id='mySearch' height='100px' width='100px' onkeyup='myFunction()' placeholder='Search for data logs with time stamps..' title='Type in a name'>";
	      
	 echo "<TABLE id='c4ytable'>";
	  echo "<TR><TH>Sr.No.</TH><TH>Workers</TH><TH>pH Level</TH><TH>Humidity</TH><TH>Load Pressure</TH><TH>Time</TH></TR>";  
				...
				<div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2019 <a href="">Students Care India Foundation </a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
